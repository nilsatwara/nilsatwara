...
<body>
    <div class="container"><br><br>
       ...
       <br><br>
       <button class="btn btn-danger"><a href="{{url('/customer/view');}}" style="text-decoration: none" class="text-white">Customer View</a></button>
       <br>
    ...
    @endif --}}
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <td><button class="btn btn-info"><a href="{{route('customer.restore',['id'=> $customer_list->customer_id])}}" style="text-decoration: none" class="text-white">Restore</a></button></td>

                <td><button class="btn btn-danger">
                    <a href="{{route('force.delete',['id' => $customer_list->customer_id])}}" style="text-decoration: none;" class="text-white">Delete</a>
                </button>
                </td>
